...
public class Assets {
	...
	static void get(AssetManager asset) {
		...
		CONTEXT = VertContext.of(SHADER, new VertexAttribute(Usage.Position, 3, "pos0"),
				new VertexAttribute(Usage.ColorPacked, 4, "color0"),
				new VertexAttribute(Usage.ColorPacked, 4, "normal0"),
	...
	private static void getSkin() {
		...
		SKIN.add(DEFAULT,
				new TouchpadStyle(
						new TexRegDrawable(new TextureRegion(GUI, 0, 96, 32, 32),
								new Color(12 / 255f, 94 / 255f, 127 / 255f, 0.6f)),
						new TexRegDrawable(new TextureRegion(GUI, 32, 116, 12, 12),
								new Color(12 / 255f, 94 / 255f, 127 / 255f, 1))));
		...
		TextFieldStyle field = new TextFieldStyle(FONT, Color.WHITE, new TexRegDrawable(BLANK),
